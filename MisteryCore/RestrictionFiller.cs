    ...
    internal static class RestrictionFiller
    {
        public static IEnumerable<IRestriction> GetRestrictions()
        {
            return new List<IRestriction>
            {
                ...
                new OneWayRestriction(Personality.TanyaAnisimova, Personality.SashaMoskvicheva),
                new OneWayRestriction(Personality.RuslanShaimardanov, Personality.MarkBondarenko),
                new OneWayRestriction(Personality.RuslanShaimardanov, Personality.NastyaRozkina),
                new OneWayRestriction(Personality.RuslanShaimardanov, Personality.StefanMorozov),
